...
//                false);
    ...
    private static Mat getMatWithDetectedObjects(String cascadeClassifierPath, Mat image
        ...
        //Detecting objects
        cascadeClassifier.detectMultiScale(tempImage, objectDetections, 1.1
                , 10
    ...
    public static Mat drawARectangleInMat(Mat tempImage, Rect rect) {
        Imgproc.rectangle(tempImage, new Point(rect.x, rect.y), new Point(rect.x + rect.width
                , rect.y + rect.height), new Scalar(0, 0, 0));
        return tempImage;
    }
    ...
    private static Mat getCroppedMat(Mat tempImage, MatOfRect objectDetections) {
        ...
        Mat croppedImage = new Mat(tempImage, rectangleOfFaceToCrop);
        return croppedImage;
    }
